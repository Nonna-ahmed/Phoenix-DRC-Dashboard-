...
def load_climate():
    ...
    # days come back as the fill value -999 instead of real numbers (same
    # issue we hit and fixed for the Algeria dashboard). Drop those rows so
    # broken -999 readings never reach the map/table.
...
# "latest date" that only covers part of the area (caught during testing).
